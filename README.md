# HRI-Pipeline - Multimodal Data Streaming and Command Processing Component: aria-nlp_pkg

A Python library for handling real-time data streaming, command processing, and intention alignment in a multimodal brick manipulation system. This component manages data streaming from the Project Aria glasses, interprets the commands, performs intention alignment (gaze and speech), and implements multi-view alignment.
...
- Voice command processing with Natural Language Processing (NLP)
...
- Look for the terminal confirmation message
...
- **`voice_controller`**: Handles audio streaming, speech recognition, and initialises command processing
- **`command_parser`**: Processes and interprets spoken commands and extracts arguments for intention alignment
...
1. **Multimodal data streaming, Intention alignment and command processing component (this package):** Streams and processes data from the Meta Aria glasses
2. **[Robot Component](https://github.com/inaranger/HRI_robot_pkg):** Handles robot control
